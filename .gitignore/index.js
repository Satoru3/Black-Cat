...
console.log("La commande de l'Héros Raizel viens d'être effectuée.");
 ...
 // Hero Cantare = Muzaka
    ...
    if (message.content === prefix + "nine tails ilpyo park"){
        ...
        .addField("<:c1:719664266797383680>", "Attaque 2 adversaires avec 105% de l'ATQ, avant d'avoir 70% de chance de générer 1 [Brûlure] équivalente à 30% de l'ATQ pendant 2 tours. Si l'adversaire est déjà affecté par un malus, inflige [Augmentation des dégâts des malus] pendant 1 tour.", false)
