...
bot.on('message', message => {
    ...
    if (message.content === prefix + "ruby"){
	    ...
	    .addField(":speech_balloon:**Compétence de chef: Nous sommes les meilleurs !**")
            .addField("Augmente de 60% l'ATQ des alliés de vent si le groupe est constitué de 5 héros de vent.")
